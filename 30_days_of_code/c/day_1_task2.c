 ...
 * you can just print one variable immediately following the other on the same line. The string provided in your
 ...
 *
 * Explanation
 * When we sum the integers 14 and 12, we get the integer 16.
